...
const promptUser = () => {
  return inquirer.prompt([
    ...
    },
    {
      ...
      filter: function (name) { licenses.filter(element => element.name == data.license)[0].badge }
    },
    {
      type: 'input',
...
// licenses.filter(element => element.name == data.license)[0].badge
// filename
...
const init = () => {
  ...
  // WriteFileAsync used as a promise
  promptUser()
